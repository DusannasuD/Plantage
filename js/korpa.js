...
function cartItem(products) {
  ...
  cartItem = document.getElementById("section2");
    ...
    <!-- Proizvod -->
      ...
      <hr style="margin-top: -20px;" id="lineElement">
    `
    if (products != null) {
      ...
      cartItem.innerHTML += `
      <!-- Proizvod info -->
      <div style="margin-top: 100px;" id="itemInfo">
...
function updateTotal() {
  ...
  if (total == 0) {
    ...
    let emptyCart = document.getElementById("itemInfo");
    let txt = document.createElement("div"); 
    let text = document.createTextNode("Korpa je trenutno prazna.");
    txt.appendChild(text);
    emptyCart.insertBefore(txt, emptyCart.childNodes[0]);

    txt.style.marginTop = "-80px";
